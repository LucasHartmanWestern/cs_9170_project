...
% - Replace \chapter with \section if compiling standalone
% - Figure paths assume figs/grid_census/ and figs/grid_capture24_filtered/
% - k=10 results for census are marked [PARTIAL] where incomplete runs remain
...
Figure~\ref{fig:marginals} shows the mean relative EO reduction for each
parameter level, averaged over all other parameter combinations and both
datasets.
