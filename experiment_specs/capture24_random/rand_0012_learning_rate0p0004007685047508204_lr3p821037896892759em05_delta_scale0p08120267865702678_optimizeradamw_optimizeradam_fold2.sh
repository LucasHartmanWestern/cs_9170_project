...
python -u main.py --spec experiment_specs/capture24_random/rand_0012_learning_rate0p0004007685047508204_lr3p821037896892759em05_delta_scale0p08120267865702678_optimizeradamw_optimizeradam_fold2.yaml --device cuda:0
