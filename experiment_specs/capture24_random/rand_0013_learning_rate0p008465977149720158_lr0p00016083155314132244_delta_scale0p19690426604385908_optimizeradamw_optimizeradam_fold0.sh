...
python -u main.py --spec experiment_specs/capture24_random/rand_0013_learning_rate0p008465977149720158_lr0p00016083155314132244_delta_scale0p19690426604385908_optimizeradamw_optimizeradam_fold0.yaml --device cpu
