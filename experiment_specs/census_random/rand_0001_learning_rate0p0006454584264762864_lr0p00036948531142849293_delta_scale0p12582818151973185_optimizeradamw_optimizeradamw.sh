...
python -u main.py --spec experiment_specs/census_random/rand_0001_learning_rate0p0006454584264762864_lr0p00036948531142849293_delta_scale0p12582818151973185_optimizeradamw_optimizeradamw.yaml --device cuda:0
