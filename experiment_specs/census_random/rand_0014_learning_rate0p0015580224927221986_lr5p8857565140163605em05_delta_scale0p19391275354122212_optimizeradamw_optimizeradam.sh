...
python -u main.py --spec experiment_specs/census_random/rand_0014_learning_rate0p0015580224927221986_lr5p8857565140163605em05_delta_scale0p19391275354122212_optimizeradamw_optimizeradam.yaml --device cpu
