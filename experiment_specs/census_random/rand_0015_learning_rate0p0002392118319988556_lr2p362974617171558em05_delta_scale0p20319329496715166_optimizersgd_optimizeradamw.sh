...
python -u main.py --spec experiment_specs/census_random/rand_0015_learning_rate0p0002392118319988556_lr2p362974617171558em05_delta_scale0p20319329496715166_optimizersgd_optimizeradamw.yaml --device cuda:0
