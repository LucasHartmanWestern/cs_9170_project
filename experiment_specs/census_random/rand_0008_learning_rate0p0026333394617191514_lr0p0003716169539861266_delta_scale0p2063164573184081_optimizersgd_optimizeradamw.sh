...
python -u main.py --spec experiment_specs/census_random/rand_0008_learning_rate0p0026333394617191514_lr0p0003716169539861266_delta_scale0p2063164573184081_optimizersgd_optimizeradamw.yaml --device cuda:0
