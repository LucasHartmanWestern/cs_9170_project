...
python -u main.py --spec experiment_specs/census_random/rand_0009_learning_rate0p004530295770311979_lr4p6373542652131554em05_delta_scale0p23256964408830622_optimizersgd_optimizeradam.yaml --device cpu
