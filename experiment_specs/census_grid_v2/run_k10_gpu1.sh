...
SPECS=(
  experiment_specs/census_grid_v2/census_k10_r04_e30.yaml
  experiment_specs/census_grid_v2/census_k10_r06_e10.yaml
  experiment_specs/census_grid_v2/census_k10_r06_e20.yaml
  experiment_specs/census_grid_v2/census_k10_r06_e30.yaml
)
cd "$(dirname "$0")/../.."
