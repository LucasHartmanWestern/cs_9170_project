...
# Launch: bash experiment_specs/capture24_kfold_grid/baselines/run_baselines_fold2_lambda.sh
set -eo pipefail
...
SPECS=(
  ...
  experiment_specs/capture24_kfold_grid/baselines/gaussian_ot_repair_fold2.yaml
)
